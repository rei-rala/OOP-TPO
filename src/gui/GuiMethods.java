...
public interface GuiMethods {
  ...
  default int validarInt(String input) throws GuiException, ValorException {
    try {
  ...
  default double validarDouble(String input) throws GuiException, ValorException {
    try {
      if (input == null || input.isBlank()) {
        throw new GuiException("Cancelado por usuario");
      }
      return redondearDouble(Double.parseDouble(input));
    } catch (GuiException e) {
      throw e;
    } catch (Exception e) {
  ...
  default double guiValidarDouble(String message, int min) throws GuiException {
    try {
  ...
  default double guiValidarDouble(String message, int min, int max) throws GuiException {
    try {
      double parsedDouble = guiValidarDouble(message);
